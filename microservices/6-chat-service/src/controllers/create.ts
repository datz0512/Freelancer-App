...
import { BadRequestError, IMessageDocument, uploads } from '@datz0512/freelancer-shared';
...
const message = async (req: Request, res: Response): Promise<void> => {
  ...
  res
    ...
    .json({ message: 'Message added.', conversationId: messageData.conversationId, messageData });
};
